...
const Help = () => {
  ...
  const inputClass =
    "border border-black dark:border-white bg-transparent px-3 py-2 rounded";

  const buttonClass = (loading) =>
    `border border-black dark:border-white px-4 py-2 rounded transition flex justify-center items-center ${
      loading
